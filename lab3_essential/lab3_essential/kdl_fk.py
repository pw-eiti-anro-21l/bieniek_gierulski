...
class KDL_fk(Node):
    ...
    def create_chain(self):
        ...
        f1 = Frame(Rotation.RPY(j3_rpy[0], j3_rpy[1], j3_rpy[2]), Vector(j3_xyz[0], j3_xyz[1], j3_xyz[2]))
        s1 = Segment(j1, f1)
        self.chain.addSegment(s1)
        j3 = Joint(Joint.RotZ)
        f3 = Frame(Rotation.RPY(j4_rpy[0], j4_rpy[1], j4_rpy[2]), Vector(j4_xyz[0], j4_xyz[1], j4_xyz[2]))
        s3 = Segment(j3, f3)
